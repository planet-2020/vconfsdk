...
//            modules.add(module);
//
//            field = chapter.getDeclaredField("rspIdNamesMap");
//            field.setAccessible(true);
//            this.rspIdNamesMap.putAll((Map<? extends String, ? extends List<String>>) field.get(null));
...
//    }
//
//    List<String> getReqNames(String reqId){  // TODO delete
...
//    }
//
//    String getRspId(String rspName){ // TODO delete
//        for (Map.Entry<String, List<String>>  entry : rspIdNamesMap.entrySet()){
//            for (String name : entry.getValue()){
//                if (name.equals(rspName)){
//                    return entry.getKey();
//                }
//            }
//        }
...
//    }
//
//    List<String> getRspName(String rspId){
//        return rspIdNamesMap.get(rspId);
//    }
//
...
//    }
//
//    boolean isResponse(String msgName){ // TODO delete
