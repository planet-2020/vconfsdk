...
public final class MakeCallResult {
    ...
    public boolean inPureAudioManner; // 是否是纯音频入会

    public MakeCallResult(String e164, String alias, String email, int callBitRate, boolean isP2p, boolean inPureAudioManner) {
        this.e164 = e164;
        this.alias = alias;
        this.email = email;
        this.callBitRate = callBitRate;
        this.isP2p = isP2p;
        this.inPureAudioManner = inPureAudioManner;
    }
